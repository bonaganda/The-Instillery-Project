...
<html>
    <head>
        <title>Fifa Scoring System</title>
        <!--W3SCHOOL CSS -->
    ...
    <body style="background-image: url(Images/websitebackground.jpg);  font-family: 'Exo'; text-align: center; 
       ...
       <!--Result-->
        ...
        <!--Add Fifa Game Form-->
        <form method="POST" id="fifaform">
            Player 1
            <br>
            <input class="btn w3-border" type="number" id="player1" name="player1" placeholder="Player ID" required><br><br>
            <input class="btn w3-border" type="number" id="p1score" name="p1score" placeholder="Player Score" required><br><br>
        ...
        <div class="w3-container">
            ...
            <!--Modal Page Content End-->
        </div>
        <!--Modal Container End-->

        <!--Own Style JavaScript -->
        <script src="js/addfifa.js"></script>
