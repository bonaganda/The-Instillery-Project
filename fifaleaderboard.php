                        ...
                        <div class="w3-text-white w3-card-4">
                            <div class="w3-display-container">
                             ...
                             <div class="w3-container">
                              ...
                              <br><br><br><br>
                              <?php
                              $sql = "SELECT register.FULLNAME, gameData.FIFA_SCORE FROM register inner join gameData on register.ID = gameData.ID WHERE FIFA_SCORE = (select max(FIFA_SCORE) from gameData)";
