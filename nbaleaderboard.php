                    ...
                    <div style="background-color: transparent;">
                        <div class="w3-text-white w3-card-4">
                            <div class="w3-display-container">
                                <center>
                                <img src="getImage.php" class= "w3-circle" style=" position: absolute; bottom:-20%; left:35.5%; width:30%" alt=""><br><br><br><br>
                                </center>
...
<!--                <table class="w3-table-all" style="position:relative;">-->
                  <table id="customers">
                    ...
                    <?php
                    $sql = "SELECT register.FULLNAME,  gameData.NBA_SCORE, gameData.RANKPOINTS
                    FROM register inner join gameData on register.ID = gameData.ID ORDER BY gameData.NBA_SCORE DESC";
                    $result = mysqli_query($con, $sql);
                    $rank = 1;
